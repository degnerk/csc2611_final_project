...
def main():
    ...
    # Add final dense layer with 40 for the 40 classes of doggos
    outputs = keras.layers.Dense(40, activation = 'softmax')(x)
...
def save_loss_plot(history, args):
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.title('Dog Breed Classifier, Batch Size: ' + args.batch_size + ' Epochs: ' + args.epochs)
    plt.legend()
