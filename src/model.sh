...
command="python model.py --data home/degnerk/FinalProject/70-dog-breedsimage-data-set-updated --batch_size 32 --epochs 10 --main_dir home/degnerk/FinalProject --augment_data false --fine_tune false"
