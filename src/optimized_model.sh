...
SBATCH --mail-user=kettnert@msoe.edu
...
command="horovodrun -np 2 -H localhost:2 python optimized_model.py --data /home/kettnert/FinalProject/data/70-dog-breedsimage-data-set-updated --batch_size 32 --epochs 10 --main_dir /home/kettnert/FinalProject --augment_data true --fine_tune true"
